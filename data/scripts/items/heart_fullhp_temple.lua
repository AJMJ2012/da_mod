...
--[[
	...
	GamePrintImportant( "$log_heart_fullhp_temple", GameTextGet( "$logdesc_heart_fullhp_temple", tostring(math.floor((max_hp - max_hp_old) * 25)), tostring(math.floor(max_hp * 25)), tostring(math.floor((hp - hp_old) * 25)) ) )
